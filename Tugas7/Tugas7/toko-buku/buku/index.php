...
<body>
<div class="navbar"><span>📖</span><h1>Manajemen Buku <span style="font-size:0.9em;opacity:0.9;">| <a href="../logout.php" style="color:#ffeb3b;text-decoration:none;font-weight:500;">Logout (<?php echo $_SESSION['username']; ?>)</a></span></h1></div>
<div class="container">
    <div class="top">
        <h2>Daftar Buku</h2>
