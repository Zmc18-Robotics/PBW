...
<body>
<div class="navbar"><span>🛒</span><h1>Buat Pesanan Baru <span style="font-size:0.9em;opacity:0.9;">| <a href="../logout.php" style="color:#ffeb3b;text-decoration:none;font-weight:500;">Logout (<?php echo $_SESSION['username']; ?>)</a></span></h1></div>
<div class="form-box">
    <h2>Form Pesanan</h2>
    <?php if ($error): ?>
